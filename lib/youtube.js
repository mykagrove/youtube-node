...
var YouTube = function() {
  ...
  */
  ...
  /**
  * Video comments from query (mykemod)
  * @param {string} youtubeId
  * @param {function} callback
  * e.g.
  * https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&videoId=BwB6Db9XKKc&key=AIzaSyBEbdwadwar0PpN8xnKsu28KRE8Iks&maxResults=100&textFormat=plainText
  */
  self.comments = function(youtubeId, callback) {
    var validate = self.validate();
    ...
    if (validate !== null) {
      ...
      self.addParam('part', self.getParts());
      self.addParam('videoId', youtubeId);
      self.addParam('maxResults', 100);
      self.addParam('textFormat', 'plainText');
